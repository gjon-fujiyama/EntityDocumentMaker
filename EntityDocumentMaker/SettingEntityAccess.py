...
class SettingEntityAccess():
    ...
    # 登録処理
    def entityInsert(self, setting_list):
        path = SQLITE3_NAME
        ...
        for settingMasterData in self.setting_list:
    ...
    def entitySearchAll(self):
        ...
        for settingMaster in settingMasters:
            ...
            result = [str(row_count)
                    ...
                    , settingMaster.set_import_path
                    , '済'
                    , str(settingMaster.id)
                    , settingMaster.type_section
    ...
    def getAllEntityPath(self):
        ...
        # row_count = 1
        # for settingMaster in settingMasters:
        #     result_path_list.append(settingMaster.set_import_path)
        #
        # return result_path_list
        return settingMasters
